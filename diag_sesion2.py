...
# Buscar la sesion TTPIPSES9-ABR-S3
r=requests.get(f"{URL}/rest/v1/sesion?cod_clase=eq.TTPIPSES9-ABR-S3&select=id,num_alumnos",headers=H)
sid=r.json()[0]['id']; n=r.json()[0]['num_alumnos']
print(f'Sesion TTPIPSES9-ABR-S3  id={sid}  alumnos={n}\n')
